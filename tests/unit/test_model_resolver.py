...
class TestNormalizeModelName:
    ...
    def test_normalizes_haiku_dash_to_dot(self):
        ...
        result, _ = normalize_model_name("claude-haiku-4-5")
    ...
    def test_normalizes_sonnet_dash_to_dot(self):
        ...
        result, _ = normalize_model_name("claude-sonnet-4-5")
    ...
    def test_normalizes_opus_dash_to_dot(self):
        ...
        result, _ = normalize_model_name("claude-opus-4-5")
    ...
    def test_strips_date_suffix_haiku(self):
        ...
        result, _ = normalize_model_name("claude-haiku-4-5-20251001")
    ...
    def test_strips_date_suffix_sonnet(self):
        ...
        result, _ = normalize_model_name("claude-sonnet-4-5-20250929")
    ...
    def test_strips_date_suffix_opus(self):
        ...
        result, _ = normalize_model_name("claude-opus-4-5-20251101")
    ...
    def test_strips_latest_suffix(self):
        ...
        result, _ = normalize_model_name("claude-haiku-4-5-latest")
    ...
    def test_keeps_model_without_minor(self):
        ...
        result, _ = normalize_model_name("claude-sonnet-4")
    ...
    def test_strips_date_from_model_without_minor(self):
        ...
        result, _ = normalize_model_name("claude-sonnet-4-20250514")
    ...
    def test_normalizes_legacy_format(self):
        ...
        result, _ = normalize_model_name("claude-3-7-sonnet")
    ...
    def test_normalizes_legacy_format_with_date(self):
        ...
        result, _ = normalize_model_name("claude-3-7-sonnet-20250219")
    ...
    def test_normalizes_legacy_haiku(self):
        ...
        result, _ = normalize_model_name("claude-3-5-haiku")
    ...
    def test_normalizes_legacy_opus(self):
        ...
        result, _ = normalize_model_name("claude-3-0-opus")
    ...
    def test_inverted_format_with_high_suffix(self):
        ...
        result, _ = normalize_model_name("claude-4.5-opus-high")
    ...
    def test_inverted_format_with_low_suffix(self):
        ...
        result, _ = normalize_model_name("claude-4.5-sonnet-low")
    ...
    def test_inverted_format_with_thinking_suffix(self):
        ...
        result, _ = normalize_model_name("claude-4.5-opus-high-thinking")
    ...
    def test_inverted_format_requires_suffix(self):
        ...
        result2, _ = normalize_model_name("claude-4.5-sonnet")
    ...
    def test_passthrough_auto(self):
        ...
        result, _ = normalize_model_name("auto")
    ...
    def test_handles_unknown_format(self):
        ...
        result, _ = normalize_model_name("gpt-4")
    ...
    def test_handles_random_model_name(self):
        ...
        result, has_thinking = normalize_model_name("some-random-model")

        print(f"Comparing result: Expected 'some-random-model', Got '{result}'")
        assert result == "some-random-model"
        print(f"Comparing has_thinking: Expected False, Got {has_thinking}")
...
class TestNormalizeModelNameThinkingSuffix:
    """
    Tests for -thinking suffix detection and removal.

    When a model name ends with -thinking, it should:
    1. Return the normalized model name WITHOUT -thinking
    2. Return has_thinking_suffix=True
    """

    def test_standard_format_with_thinking_suffix(self):
        """
        What it does: claude-sonnet-4-5-thinking → (claude-sonnet-4.5, True)
        Goal: Check -thinking suffix detection for standard format.
        """
        print("Action: Normalizing 'claude-sonnet-4-5-thinking'...")
        result, has_thinking = normalize_model_name("claude-sonnet-4-5-thinking")

        print(f"Comparing result: Expected 'claude-sonnet-4.5', Got '{result}'")
        assert result == "claude-sonnet-4.5"
        print(f"Comparing has_thinking: Expected True, Got {has_thinking}")
        assert has_thinking is True

    def test_haiku_with_thinking_suffix(self):
        """
        What it does: claude-haiku-4-5-thinking → (claude-haiku-4.5, True)
        Goal: Check -thinking suffix for Haiku.
        """
        print("Action: Normalizing 'claude-haiku-4-5-thinking'...")
        result, has_thinking = normalize_model_name("claude-haiku-4-5-thinking")
    ...
    def test_opus_with_thinking_suffix(self):
        """
        What it does: claude-opus-4-6-thinking → (claude-opus-4.6, True)
        Goal: Check -thinking suffix for Opus.
        """
        print("Action: Normalizing 'claude-opus-4-6-thinking'...")
        result, has_thinking = normalize_model_name("claude-opus-4-6-thinking")
    ...
    def test_inverted_format_with_thinking_suffix(self):
        """
        What it does: claude-4.5-opus-thinking → (claude-opus-4.5, True)
        Goal: Check -thinking suffix for inverted format.
        """
        print("Action: Normalizing 'claude-4.5-opus-thinking'...")
        result, has_thinking = normalize_model_name("claude-4.5-opus-thinking")
    ...
    def test_already_normalized_with_thinking_suffix(self):
        """
        What it does: claude-sonnet-4.5-thinking → (claude-sonnet-4.5, True)
        Goal: Check -thinking suffix for already normalized format.
        """
        print("Action: Normalizing 'claude-sonnet-4.5-thinking'...")
        result, has_thinking = normalize_model_name("claude-sonnet-4.5-thinking")
    ...
    def test_without_thinking_suffix_returns_false(self):
        """
        What it does: claude-sonnet-4-5 → (claude-sonnet-4.5, False)
        Goal: Check that models without -thinking return False.
        """
        print("Action: Normalizing 'claude-sonnet-4-5'...")
        result, has_thinking = normalize_model_name("claude-sonnet-4-5")
    ...
    def test_case_insensitive_thinking_suffix(self):
        """
        What it does: claude-sonnet-4-5-THINKING → (claude-sonnet-4.5, True)
        Goal: Check case insensitivity for -thinking suffix.
        """
        print("Action: Normalizing 'claude-sonnet-4-5-THINKING'...")
        result, has_thinking = normalize_model_name("claude-sonnet-4-5-THINKING")
    ...
    def test_thinking_with_date_suffix(self):
        """
        What it does: claude-sonnet-4-5-20250929-thinking → (claude-sonnet-4.5, True)
        Goal: Check -thinking suffix with date suffix.
        """
        print("Action: Normalizing 'claude-sonnet-4-5-20250929-thinking'...")
        result, has_thinking = normalize_model_name(
    ...
    def test_auto_model_returns_false(self):
        """
        What it does: auto → (auto, False)
        Goal: Check that 'auto' model returns False for thinking.
        """
        print("Action: Normalizing 'auto'...")
        result, has_thinking = normalize_model_name("auto")
...
class TestNormalizeModelNameParametrized:
    ...
    def test_normalize_model_name_all_scenarios(self, input_model, expected):
        ...
        result, _ = normalize_model_name(input_model)
...
class TestModelAliasSystemEdgeCases:
    ...
    def test_alias_to_non_existent_model(self, mock_model_cache):
        ...
        print(
            f"Comparing internal_id: Expected 'claude-haiku-5.0', Got '{result.internal_id}'"
        )
    ...
    def test_alias_case_sensitivity(self, mock_model_cache):
        ...
        print(
            f"Comparing internal_id: Expected 'AUTO-KIRO' (passthrough preserves case), Got '{result.internal_id}'"
        )
